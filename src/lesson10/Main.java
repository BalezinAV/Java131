...
//        System.out.println("Проверка изменений на GitHub");
        //Команд
        // для работы с GitHub по сохранению изменений.
//        0) git status
//        1) git add.
...
//        4) git push – без дополнительных обозначений. Публикация удаленного репозитория. Переносим комит (контрольную точку с локального репозитория, на удаленный репозиторий).
        // Для доступа к файлу можно копировать ссылку из браузера. Либо жмем на тсроку (...) жмем на точки выбираем пункт copy permalink.
        // ДЗ от 31.01.24 -2- Создать репозиторий для домашних заданий. Создать новый файли, создать принтлн и загрузить на гитхаб. Прислать ссылку на документ, либо на строку. В блок ДЗ ввести ссылку в комментарий.

        // Лекция от 05.02.2024г. Продолжаем GitHub. Подключение другого рабочего места. -1- до 0.30. ДЗ до 0.56.

        // Сдвиг в право.
//        System.out.println(0b101 >> 1); // Сдвиг в право на 1 символ. Все числа сдвигаются в двоичном представлении, первое число становится 0, если первым был 0 и 11 если первым была 1, крайнее заменяется на предпоследнее.
//        System.out.println(Integer.toBinaryString(5 >> 1)); // Преобразуем десятичное в двоичное. 10
//        System.out.println(Integer.toBinaryString(0b101 >> 1)); // 10

        // Делаем метод
//        printBinariString(5);
////        printBinariString(5 >> 1);
////        printBinariString(0b101 >> 2);
////        printBinariString(Integer.MIN_VALUE);
////        printBinariString(Integer.MIN_VALUE >> 2);
////        printBinariString(Integer.MIN_VALUE >>> 2); // >>> Заполняет 0 первые 2 места. 1-й бит знаковый, если 1 то это отрицательное число, если 0 то положительное
//        printBinariString(0b101 << 2);
//    }
//
//    public static void printBinariString(int hexNumber) {
...
//    }
//}
// 05.02.2024 -2- Объектно ориентированное программирование.
        // Создаем пакет 11
    }
}

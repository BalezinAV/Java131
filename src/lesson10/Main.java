...
//        System.out.println(5 >> 2);
        ...
        // Когда находились на ветке мастер и создали ридми, все что было на ветке мстер, перенслось на ветку ридми. И когда мы в вете создаил документ ридме, то он остался на ветке ридми, из мастера он ушел.

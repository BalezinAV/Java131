...
//    } //Конец блока метод.
        ...
        //Задача. Перегрузка метода для нахождения суммы двух ит трех целых чисел. При передаем переменные с разными названиями, но с одинаковыми типами данных, написать повторно функцию с таким же названием не можем.
//        int a = 7;
//        int b = 3;
//        int c = 5;
